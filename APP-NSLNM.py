...
PNI = st.selectbox("PNI:", options=list(embryos.keys()), format_func=lambda x: PNI[x])

# cp: categorical selection
MLR = st.selectbox("MLR:", options=list(embryos.keys()), format_func=lambda x: MLR[x])

# cp: categorical selection
BMI = st.selectbox("BMI:", options=list(embryos.keys()), format_func=lambda x: BMI[x])

# cp: categorical selection
SII = st.selectbox("SII:", options=list(embryos.keys()), format_func=lambda x: SII[x])

# cp: categorical selection
ALP = st.selectbox("ALP:", options=list(biochemical.keys()), format_func=lambda x: ALP[x])
